...
pub const VERSION: &str = "1.2.07.24";
...
fn main() {
    ...
    let metadata = metadata::Metadata::new(&collection_date, &tenant_with_time, VERSION, &schema.schema_version, (end - start).num_seconds(), (total_end - total_start).num_seconds(), error_length, token_metadata, dumper.tables, prerequisites_metadata, services_metadata);
